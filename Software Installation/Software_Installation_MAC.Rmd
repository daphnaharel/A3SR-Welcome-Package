...
Note: Instructions were written for macOS Mojave. The new version of R is for macOS El Capitan or higher. Please make sure your computer is up to date before installing software. Furthermore, note that a newer version of R and RStudio is currently available than what is pictured here, but instructions to download are the same.
...
# 2. Download and Install RStudio
  ...
  * Scroll past the comparison chart to the Installers for Supported Platforms section and choose **RStudio 1.2.1335 - Mac OS X 10.12+ (64-bit)**
  \newline
  ![](./Installation Images/RStudio_Installation_MAC.png){width=75%}
\newline
...
\newline
![](./Installation Images/RStudio_mac.png){width=75%}
\newline
...
http://www.tug.org/mactex/mactex-download.html
  + Click on **MacTeX.pkg**
  \newline
  ![](./Installation Images/LaTeX_mac.png){width=75%}
    \newline
